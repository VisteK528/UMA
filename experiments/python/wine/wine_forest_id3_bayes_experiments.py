...
if __name__ == "__main__":
    ...
    model = RandomForestClassifier(classifiers_number=50, tree_percentage=0.5, discrete_x=False, discretization_type="percentile", n_jobs=24)
    ...
    evaluate_binary_tests(y_true_test, y_pred_test, test_accuracies, train_accuracies, ATTEMPTS, SAVE_IMAGES, SAVE_RESULTS,
                              "wine", "forest_id3_bayes", ["bad", "good"])