...
if __name__ == "__main__":
    ...
    if SAVE_IMAGES:
        plt.savefig("images/credit_score_forest_id3_cm.pdf")
    ...
    # 0 vs rest
    ovr_cm(y_true_ovr, y_pred_ovr, 0, "abnormal", ATTEMPTS, SAVE_IMAGES, "images/credit_score_forest_id3_cm_class=0.pdf")

    precision_list_0, tpr_list_0, fpr_list_0 = ovr_test(y_true_ovr, y_pred_ovr, 0, SAVE_IMAGES,
                                                        "images/credit_score_forest_id3_roc_class=0.pdf")
    ...
    # 1 vs rest
    ovr_cm(y_true_ovr, y_pred_ovr, 1, "normal", ATTEMPTS, SAVE_IMAGES, "images/credit_score_forest_id3_cm_class=1.pdf")

    precision_list_1, tpr_list_1, fpr_list_1 = ovr_test(y_true_ovr, y_pred_ovr, 1, SAVE_IMAGES,
                                                        "images/credit_score_forest_id3_roc_class=1.pdf")
    ...
    ovr_cm(y_true_ovr, y_pred_ovr, 2, "inconclusive", ATTEMPTS, SAVE_IMAGES,
           "images/credit_score_forest_id3_cm_class=2.pdf")

    precision_list_2, tpr_list_2, fpr_list_2 = ovr_test(y_true_ovr, y_pred_ovr, 2, SAVE_IMAGES,
                                                        "images/credit_score_forest_id3_roc_class=2.pdf")
